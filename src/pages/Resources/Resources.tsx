  ...
  return (
    <Layout>
      ...
      <main>
        ...
        <H3><Link to="/resources/ludodemia">Ludodemia</Link></H3>
        ...
        <H3><Link to="/resources/games-research-journals">Games Research Journals</Link></H3>
        <p>A comprehensive listing of academic journals and publications known to publish research related to digital games.</p>

        <H3><Link to="/resources/games-research-positions">Games Research Positions</Link></H3>
        <p>A comprehensive listing of academic positions related to gaming research.</p>

        <H3><Link to="/resources/games-research-twitter">Games Researchers on Twitter</Link></H3>
